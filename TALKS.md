...
## 2026
- [English] React Performance in the Age of AI - Jenna Zeigen - by NY Web Performance Meetup ~ [video](https://www.youtube.com/watch?v=FvxIrXy18TQ)
...
## 2025
- [English] 7 Levels of a Web Performance Journey - by NY Web Performance Meetup ~ [video](https://www.youtube.com/watch?v=tFzMOee0ymw)
- [English] Performance on a Budget: Lessons from Building a Nonprofit SaaS Platform - by NY Web Performance Meetup ~ [video](https://www.youtube.com/watch?v=6ros6iNSdVU)
- [English] CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=u76IcrzZPwc)
- [English] 7 Levels of a Web Performance Journey - Sergey Chernyshev - performance.sync() 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=2cv6wwjRtfI)
- [English] Design Token Architecture - Brad and Ian Frost - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=u5okJ0VvQwk)
- [English] Scope in CSS - Chris Coyier - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=VO1uz2zVCBU)
- [English] The goose and the common - Bruce Lawson - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=OWDvt85qJNQ)
- [English] Level, Up your Scroll UX - Adam Argyle - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=vPb7d28RFNE)
- [English] Is Sass Dead Yet? CSS Mixins and Functions - Miriam Suzanne - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=IIvqkkfmPYE)
- [English] display: green; applying the web sustainability guidelines - Hidde de Vries - Smart Layouts - Ahmad Shadeed - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=_njUxg5UfR0)
- [English] A Dao of CSS - John Allsopp - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=-iV1I7_0New)
- [English] Building a Computer with CSS - Amit Sheen - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=PFqtjjpfp6o)
- [English] Refactoring CSS - Ana Rodrigues - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=IufuVE2r3RA)
- [English] Styling new HTML UI capabilities - Brecht De Ruyte - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=SsBC0dx0xyM)
- [English] CSS tried to come for my Job - Cyd Stumpel - CSS Day 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=rPXSDuGev8g)
- [English] Speculations about Web Performance - Barry Pollard - performance.now() 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=DqE9WV76wFo)
- [English] Measuring Interactions and Navigations - Michal Mocny - performance.now() 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=sDHSn-OryV8)
- [English] Peak Performance with Partytown - Julian Jandl - performance.sync() 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=rFrqJQshh6M)
- [English] Compression Dictionaries: Early Findings - Robin Marx - performance.sync() 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=hIfHuacyQc8)
- [English] Noise-Cancelling RUM-Based Alerting - Brian Ramirez - performance.sync() 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=dt7cIb_zKWk)
- [English] Using Model Context Protocol (MCP) - Michael Hablich - performance.sync() 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=XuJwgpJePP0)
- [English] Speculation Rules in a Nutshell - Medhat Dawoud - performance.sync() 2025 - by Web Conferences Amsterdam ~ [video](https://www.youtube.com/watch?v=TWomRHSevgc)
...
### 2013
- [English] Jank Free: Chrome Rendering Performance (2013) - by Nat Duca and Tom Wiltzius ~ [video](https://www.youtube.com/watch?v=n8ep4leoN9A)
...
- [English] A developer's guide to rendering performance (2013) - by Paul Lewis ~ [video](https://vimeo.com/77591536) / [slides](https://speakerdeck.com/paullewis/a-developers-guide-to-rendering-performance)
- [English] Performance Tooling (2013) - by Paul Irish ~ [video](https://www.youtube.com/watch?v=HAqjyCH_LOE)
